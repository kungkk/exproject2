...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected, bMultiselect) {
            ...
            //console.debug(sLabel);
            //lbl = "";
            //if (sLabel.indexOf('Product') == -1) sLabel = "All Products";
            //if (sLabel.indexOf('Equipment') == -1) sLabel = "All Equipments";
            //if (sLabel.indexOf('Parameter') == -1) sLabel = "All Parameters";
            //if (sLabel.indexOf('Customer') == -1) sLabel = "All Customers";
            //sLabel = "";
            var r = '<select class="search_init select_filter form-control" rel="' + i + '"><option value="" class="search_init">' + sLabel + '</option>';
            //var r = '<select class="search_init select_filter form-control" rel="' + i + '"><option value="" class="search_init">'+lbl+'</option>';
            if(bMultiselect) {
